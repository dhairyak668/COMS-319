...
function split_and_matrix(matrix) {
    ...
    for (let element of splitRowByRow) {
        let splitEveryElementInRow = element.split(',');
        matrix.push(splitEveryElementInRow);
    }
    //console.log(matrix);
}
...
const iristable = [
    ["Setosa",setosa_sepal_Length,setosa_sepal_Width,setosa_petal_Length,setosa_petal_Width, setosa_count ],
    ["Versicolor",versicolor_sepal_Length,versicolor_sepal_Width,versicolor_petal_Length,versicolor_petal_Width, versicolor_count ],
    ["Virginica",virginica_sepal_Length,virginica_sepal_Width,virginica_petal_Length,virginica_petal_Width, virginica_count ],
];
